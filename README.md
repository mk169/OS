...
| Bereich | Inhalt |
| --- | --- |
| **Start** | Tagesüberblick in sieben wählbaren Stilen (Todo-Liste, Gamified, Terminal, Clean Girl, Notion, Life OS, Locked In) – der Stil prägt Start, Todos und Habits |
...
mit Playwright durch (29 Tests): Einrichtung, alle Bereiche öffnen, Todo mit
...
der sieben Stile auf Start, Todos und Habits – dazu ein Start mit absichtlich
